...
static MatrixXd vortex_vel(N,2);

void printVortex(const MatrixXd & vortex_xy, const VectorXd & vortex_G, double runTime, int fileNumber){
...
void printDiagnostics(double hamiltonianValue, double momentumxValue, double momentumyValue, double runTime, int fileNumber){
    ...
    fout_hamiltonian << runTime << " " << hamiltonianValue << " " << momentumxValue << " " << momentumyValue << endl;
